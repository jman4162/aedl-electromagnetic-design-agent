...
v0 — one task (`t2-001`), evaluator interface, CLI. Task tiers planned:

- **Tier 1 — element**: unit cells, patch antennas (full-wave via
  [EdgeFEM](https://github.com/jman4162/EdgeFEM))
- **Tier 2 — aperture**: array pattern synthesis under hardware constraints
  ([phased-array-modeling](https://github.com/jman4162/Phased-Array-Antenna-Model))
- **Tier 3 — system**: requirement-driven trades, link budgets
  ([phased-array-systems](https://github.com/jman4162/phased-array-systems))
...
tasks/t2-001-steered-beam-2bit/
  ...
  reference/solve.py # dithered 2-bit quantization; passes all requirements
```
