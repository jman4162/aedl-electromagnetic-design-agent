#!/usr/bin/env bash
# slopcheck.sh — pre-publish AI-slop linter for aedl prose.
#
...
#
# Known false positive here: slopscore flags "harness" as an
# over-polished verb, but it is this project's name for a component
# (the agent harness) and is always used as a noun. That accounts for
# essentially every remaining LEXICAL_OVERPOLISHED_VERBS finding.
#
# Usage:
...
# style are hidden; readability scores are meaningless for docs full of
# code identifiers and dB figures.
